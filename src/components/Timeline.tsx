      ...
      <div className="container relative mx-auto px-4">
        <div className="text-center max-w-3xl mx-auto mb-16 animate-fade-in-up">
          ...
          <p className="text-lg text-muted-foreground">
            A phased approach ensuring systematic implementation with measurable
            milestones and continuous value delivery.
          </p>
        </div>
        ...
        <div className="mt-16 max-w-3xl mx-auto p-8 rounded-2xl border border-primary/20 bg-gradient-to-br from-primary/5 to-secondary/5 backdrop-blur-sm">
          <div className="text-center space-y-4">
            <h3 className="text-2xl font-bold">Transformation Journey</h3>
            <p className="text-muted-foreground">
              From fragmented manual processes to a fully automated, AI-powered
              technology intelligence platform delivering real-time strategic
              insights.
            </p>
          </div>
        </div>
